...
const SideNav = () => {
    ...
    return (
        <div>
            <button onClick={toggleDropdown} data-drawer-target="sidebar-multi-level-sidebar" data-drawer-toggle="sidebar-multi-level-sidebar" aria-controls="sidebar-multi-level-sidebar" type="button" 
