        ...
        >
          <div className="p-12 px-18 md:space-y-6">
            ...
            <form className="relative flex flex-col items-center px-8 pt-8 pb-10 space-y-7" action="#" onSubmit={handleSubmit}>
              <div>
                <label htmlFor="email" className="flex mb-2 text-sm font-bold text-white">
                  Email:
                </label>
                <input
                  ...
                  name="email"
                  id="email"
                  className="bg-white border-solid border-[3px] border-borderColor
                                focus:outline-none rounded-full block min-w-full py-2 px-4 text-gray-900 sm:text-sm md:w-[300px]"
              ...
              <div className="flex justify-center pt-2">
                {isLoading ? (
                  ...
                  <button
                    type="submit"
                    className="flex w-[150px] justify-center items-center text-center bg-white  text-black hover:bg-bgLight
              ...
              <div className="flex flex-col items-center justify-center text-sm font-bold text-white sm:pt-2 lg:flex-row lg:items-baseline">
                ...
                {' '}
                <a href="/register" className="flex items-center justify-centerfont-bold ml-2 text-[#8077FF] hover:underline md:ml-2 md:mt-0">Register here</a>
              </div>
